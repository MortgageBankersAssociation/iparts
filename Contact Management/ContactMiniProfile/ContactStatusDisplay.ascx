    ...
    <tbody>
        <tr>
            <td id="divStatusEdit" runat="server" Visible="false">
                <asiweb:BusinessDropDownList runat="server" ID="SelectStatus" RenderPanelField="true"
                ShowNullItem="false" DisplayCaption="true" PositionCaption="Top"/>
                
            </td>
            <td id="divBillingEdit" runat="server" Visible="false">
                 <asiweb:BusinessDropDownList runat="server" ID="BillingCategories" RenderPanelField="true" 
