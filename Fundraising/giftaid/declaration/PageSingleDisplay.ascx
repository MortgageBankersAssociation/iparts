...
<asp:PlaceHolder ID="phDetails" runat="server" >
    ...
    <asiweb:PanelTemplateControl ID="Ex3Fields" runat="server" FieldSet="true" ShowHeader="false" BorderStyle="None"  GroupingText="top" >
        ...
        <asiweb:PanelTemplateColumn ID="PanelTemplateColumn3" runat="server"  >
             ...
             <div class="PanelField Left" style="border-bottom-style:none;">
                 ...
                 <div  class="PanelFieldValue">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div><asp:RadioButton ID="SixYearRule" runat="server" GroupName="DeclarationStartDate" Text="Apply 6 year rule" AutoPostBack="true" ></asp:RadioButton>
                                <span>&nbsp;</span>
                            </div>
                            <br />
