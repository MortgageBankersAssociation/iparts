...
<script language="javascript">
    ...
    function QueryBrowseClick() {
        OpenObjectBrowser('iTypeFilter=IQD', SetQueryObject);
    }
...
<asiweb:PanelTemplateControl ID="designerPanel" runat="server" FieldSet="True" ShowHeader="False" BorderStyle="None">
    ...
    <div class="PanelField Left">
        ...
        <div class="PanelFieldValue">
            <asiweb:BusinessTextBox runat="server" ID="TextBoxPropertyName"></asiweb:BusinessTextBox>
        </div>
    </div>
    <div class="PanelField Left">
        <div>
    ...
    <div id="PropertyStringLengthDiv" runat="server">
        <div class="PanelField Left">
            ...
            <div class="PanelFieldValue">
                ...
                <asiweb:BusinessTextBox runat="server" ID="TextBoxStringLength" AutoPostBack="True"></asiweb:BusinessTextBox>
    ...
    <div id="ValueListDiv" runat="server">
        <div class="PanelField Left">
            <div>
                <asiweb:StyledLabel runat="server" ID="LabelSelectValueList" AssociatedControlID="CheckBoxSelectValueList"></asiweb:StyledLabel>
            </div>
            <div class="PanelFieldValue">
                <asiweb:BusinessCheckbox runat="server" ID="CheckBoxSelectValueList"></asiweb:BusinessCheckbox>
            </div>
        </div>
