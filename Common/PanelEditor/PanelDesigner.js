function PanelDesignerClass() 
{
    ...
    */
    ...
    this.AddFieldByTreeNodeWithProperties = function (node, rowId, columnId, customizedProperties) {
        ...
        if (isTable.toLowerCase() == "false") {
            ...
            panelDefinitionInstance.AddFieldToPanelDefinition(rowId, columnId, propertyName, cellLabel.value,
                entityName, cellReadOnly.checked, cellHideInNormalView.checked, isMultipleInstance);
        ...
        for (var rowCounter = 0; rowCounter < rowCount; rowCounter++) {
            ...
            for (var columnCounter = 0; ; columnCounter++) {
                ...
                panelDefinitionInstance.AddFieldToPanelDefinition(rowCounter, columnCounter,
                    propertyName, caption, entityName, readOnly, hideInNormalView, isMultipleInstance);
                node.set_visible(false);
    ...
    //
    this.AddSource = function (window, args) {
        ...
        if (this.IsSourceNameInUse(sourceName)) {
        ...
        //newSourceNode.set_imageUrl("http://bpye-mac/main15/App_Themes/BlueWave/images/icon_edit.gif");
        nodes.insert(2, newSourceNode);
        // Add an 'Add property' node
        var newPropertyNode = new Telerik.Web.UI.RadTreeNode();
        newPropertyNode.set_text("Add property");
    ...
    this.ClientContextMenuItemClicked = function (sender, args) {
        ...
        if (item.get_value() == "deleteSource") {
            ...
            var url = 'EditPropertyDialog.aspx?SourceName=' + sourceName + '&PropertyName=' + propertyName + '&PropertyType=' + propertyType +
                ...
                '&PropertyDecimalScale=' + propertyDecimalScale + '&PropertyIsNew=' + isNew + '&PropertyNumberOfTextboxLines=' + propertyNumberOfTextboxLines;
...
//
function CustomizablePropertiesClass(customLabel, readOnly, hideInNormalView) {
...
function PanelDefinitionClass(hiddenFieldId) {
    ...
    */
    ...
    //
    this.AddFieldToPanelDefinition = function(rowId, columnId, propertyName, caption, entityName, isReadOnly, hideInNormalView, isMultipleInstance) {
        ...
        var newField = { "PropertyName": propertyName, "Caption": caption, "EntityName": entityName, "IsReadOnly": isReadOnly, "HideInNormalView": hideInNormalView };
