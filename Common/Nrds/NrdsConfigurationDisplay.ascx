...
<telerik:RadAjaxPanel ID="ajaxPanel1" runat="server" LoadingPanelID="loadingPanel" >
    ...
    <asiweb:PanelTemplateControl ID="MemberConfig" runat="server" ShowButtons="false" ShowHeader="true" Collapsible="false" Collapsed="false" BorderWidth="0" Width="100%">
        ...
        <asiweb:PanelTemplateColumn ID="MemberCol2" runat="server">
            ...
            <asiweb:StyledLabel ID="memberEmailMap" runat="server" RenderPanelField="true" DisplayCaption="true" ShowNullItem="false" />
            <asiweb:StyledLabel ID="memberPostSyncSP" runat="server" RenderPanelField="true" DisplayCaption="true" />
        </asiweb:PanelTemplateColumn>
    </asiweb:PanelTemplateControl>
    <asiweb:PanelTemplateControl ID="OfficeConfig" runat="server" ShowButtons="false" ShowHeader="true" Collapsible="false" Collapsed="false" BorderWidth="0">
	...
	<asiweb:PanelTemplateControl ID="AssociationConfig" runat="server" ShowButtons="false" ShowHeader="true" Collapsible="false" Collapsed="false" BorderWidth="0">
...
<asp:Panel ID="contentPanelEdit" runat="server" Visible="false" CssClass="StandardPanel" BorderStyle="None" BackColor="Transparent">
    ...
    <asiweb:PanelTemplateControl ID="selectedMemberConfig" runat="server" ShowButtons="false" ShowHeader="true" Collapsible="false" Collapsed="false" BorderWidth="0" Width="100%">
    ...
    <asiweb:PanelTemplateControl ID="selectOfficeConfig" runat="server" ShowButtons="false" ShowHeader="true" Collapsible="false" Collapsed="false" BorderWidth="0">
    ...
    <asiweb:PanelTemplateControl ID="selectAssociationConfig" runat="server" ShowButtons="false" ShowHeader="true" Collapsible="false" Collapsed="false" BorderWidth="0">
