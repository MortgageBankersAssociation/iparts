...
<div class="PanelField top">
   <asp:Label ID="labelFilterLabel" runat="server" Text="Show" AssociatedControlID="PackageViewList" /> 
<asp:DropDownList ID="PackageViewList" runat="server" AutoPostBack="true">
