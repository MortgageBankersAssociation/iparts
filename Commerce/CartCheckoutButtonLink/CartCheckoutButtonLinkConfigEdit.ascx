...
<asiweb:paneltemplatecontrol ID="ContainerPanel" runat="server" FieldSet="true" ShowHeader="false" BorderStyle="None">
    <div class="AutoWidth">
       ...
       <asiweb:SmartControl ID="DisplayContinueLinkCriteriaCombo" runat="server" BoundPropertyName="DisplayMode" 
                DisplayCaption="true" PositionCaption="Left" HIControlType="ComboBox" ShowNullItem="false" ></asiweb:SmartControl>
